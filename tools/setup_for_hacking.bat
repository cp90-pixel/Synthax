...
ECHO Setup Synthax to use the HTML/CSS/JS files pulled from GitHub.
ECHO Parameters: application_path - path that contains the Synthax application
ECHO Example: setup_for_hacking.bat "c:\Program Files (x86)\Synthax"
GOTO Exit
...
ECHO (in the folder containing Synthax.exe)
